...
docs = [
    Document(
        page_content="""A bunch of scientists bring
        back dinosaurs and mayhem breaks loose""",
        metadata={"year": 1993, "rating": 7.7, "genre": "science fiction"},
    ),
    Document(
        page_content="""Leo DiCaprio gets lost in a
    ...
    Document(
        page_content="""A psychologist / detective gets
        lost in a series of dreams within dreams within
        dreams and Inception reused the idea""",
        metadata={"year": 2006, "director": "Satoshi Kon", "rating": 8.6},
    ),
    Document(
        page_content="""A bunch of normal-sized women
        are supremely wholesome and some men pine after them""",
