...
class State(TypedDict):
    ...
    user_query: str
    domain: Literal["insurance", "records"]
...
sample_docs = [
    Document(
        page_content="patient medical reords...",
        metadata={"domain": "records"}
        ),
    Document(
        page_content="Insurance policy details...",
...
router_prompt = SystemMessage(
    """You need to decide which domain
      to route the user query to.
      You have two domains to choose from:
- records: contains medical records
 of the patient, such as diagnosis,
...
medical_records_prompt = SystemMessage(
    """You are a helpful medical chatbot,
      who answers questions based on the patient's
        medical records, such as diagnosis,
          treatment, and prescriptions."""
)

insurance_faqs_prompt = SystemMessage(
    """You are a helpful medical insurance chatbot,
      who answers frequently asked questions
        about insurance policies, claims, and coverage."""
)
...
builder = StateGraph(State, input_schema=Input, Output=Output)
